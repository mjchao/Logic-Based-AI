...
public class IntegerWorldErrorConstantDefinedWithArguments {
	
	public ObjectFOL changingInt = NumbersFOL.fromInt( 5 );
	
	public IntegerWorldErrorConstantDefinedWithArguments() {
	...
	public ObjectFOL Zero( ObjectFOL dummyArg ) {
